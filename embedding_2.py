...
def load_articles(file_path: str) -> pd.DataFrame:
    """Load articles from JSON file and return as DataFrame."""
...
def prepare_texts(df: pd.DataFrame, include_content: bool = True) -> List[str]:
    """
    Prepare texts for embedding by combining title and optionally content.

    Args:
        df: DataFrame with articles
        include_content: Whether to include article content in addition to title
